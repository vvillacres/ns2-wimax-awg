...
public:
     ...
     * @return the value of arq_max_window_
     */
    inline void setMaxWindow(u_int32_t arq_max_window) {
     ...
     * @return the value of ack_period_
     */
    inline void setAckPeriod(u_int8_t ack_period ) {
     ...
     */
    inline u_int32_t getCurrSeq() {
        return arq_curr_seq_;
    }
     ...
     * @return the value of is_arq_enabled_
     */
    inline void setArqEnabled(u_char is_arq_enabled) {
     ...
     * @return the value of arq_retrans_time_
     */
    inline void setRetransTime(double arq_retrans_time) {
    ...
    * @return the value of arq_curr_seq_
    */
    inline void setCurrSeq(u_int32_t arq_curr_seq) {
        arq_curr_seq_ = arq_curr_seq;
    }
     ...
     */
    inline u_int32_t getCurrWindow() {
        return arq_curr_window_;
    }
     ...
     * @return the value of arq_curr_window_
     */
    inline void setCurrWindow(u_int32_t arq_curr_window) {
        arq_curr_window_ = arq_curr_window;
    }
     ...
     * @return the value of ack_counter_
     */
    inline void setAckCounter(u_int8_t ack_counter) {
        ack_counter_ = ack_counter;
    }
     ...
     * @return the value of ack_seq_
     */
    inline void setAckSeq(u_int32_t ack_seq) {
        ack_seq_ = ack_seq;
    }
     ...
     */
    inline u_int32_t getLastAckSent() {
     ...
     * @return the value of last_ack_sent_
     */
    inline void setLastAckSent(u_int32_t last_ack_sent) {
        last_ack_sent_ = last_ack_sent;
    }
