...
class Mac802_16;
struct PacketTimerRecord; /// added rpi.
...
{
public:
    WimaxRxTimer(Mac802_16 *m, PacketTimerRecord *ptr) : WimaxTimer(m) {
        record_=ptr;
    }
...
{
public:
    WimaxT17Timer(Mac802_16 *m, int peerIndex) : WimaxTimer(m) {
...
/*Timer to control fast feedback report. Xingting*/
class WimaxFfbTimer: public TimerHandler
{
public:
    WimaxFfbTimer(Mac802_16 *m):TimerHandler() {
        m_=m;
    }
    //protected:
    void expire(Event *e);
...
{
public:
    DlTimer(Mac802_16 *m) : TimerHandler() {
        m_=m;
    }
...
{
public:
    UlTimer(Mac802_16 *m) : TimerHandler() {
        m_=m;
    }
...
{
public:
    InitTimer(Mac802_16 *m) : TimerHandler() {
        m_=m;
    }
...
/** ArqTimer Class */
class Connection;
class ARQTimer : public TimerHandler
{

public:
    ARQTimer(Connection *connection): TimerHandler() {
