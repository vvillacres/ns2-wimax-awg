...
Mac802_16::Mac802_16() : Mac (), macmib_(this), phymib_(this)//, rxTimer_(this)
{
    ...
    bind("bs_ffb_report_period_", &bs_ffb_report_period_);
    bind("bs_ffb_report_duration_", &bs_ffb_report_duration_);
    bind("bs_ffb_report_type_", &bs_ffb_report_type_);
    bind ("amc_enable_", &amc_enable_);
