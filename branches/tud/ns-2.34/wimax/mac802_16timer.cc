...
/*Fast Feedback report. Xingting*/
void  WimaxFfbTimer::expire(Event *e)
{
    printf("wimaxFfbTimer expired.\r\n");
    m_->ffb_process();
}
...
/*
 * Indicates the beginning of UL subframe
 */
...
/*
 * Handling function for ArqTimer
 * @param e The event that occured
 */
