...
public:
    ...
    */
    ...
    /**
     * Get and Set last service time in milliseconds
     */
    inline double getLastServiceTime() {
    	return lastServiceTime_;
    }

    inline double setLastServiceTime(double lastServiceTime) {
    	lastServiceTime_ = lastServiceTime;
    }
...
private:
    ...
    /**
     * Saves the time offset, when the connection got service in milliseconds
     */
    double lastServiceTime_;
