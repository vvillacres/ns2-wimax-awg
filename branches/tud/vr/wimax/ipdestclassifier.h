...
#ifndef IPDESTCLASSIFIER_H
#define IPDESTCLASSIFIER_H
 ...
 */
class IPDestClassifier : public SDUClassifier
{
public:
     ...
     */
    IPDestClassifier (Mac802_16 *mac);
     ...
     */
    IPDestClassifier (Mac802_16 *mac, int priority_);
