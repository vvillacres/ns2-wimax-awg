...
class Mac802_16 : public Mac
{
    ...
    //friend class WimaxScheduler;  //vr@tud friend classes prevent object oriented inheritance
    //friend class BSScheduler;		//vr@tud
