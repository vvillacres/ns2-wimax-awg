...
public:
    ...
    /*
     * Set the DCD Send flag
     */
    inline void setSendDCD( bool sendDCD) {
    	sendDCD_ = sendDCD;
    }

    /*
     * Returns the DCD Send flag
     */
    inline bool getSendDCD() {
    	return sendDCD_;
    }

    /*
     * Set the UCD Send flag
     */
    inline void setSendUCD( bool sendUCD) {
    	sendUCD_ = sendUCD;
    }

    /*
     * Returns the UCD Send flag
     */
    inline bool getSendUCD() {
    	return sendUCD_;
    }

    /**
     * Set DL configuration change count
     */
    inline void setDlCCC(int dlccc) {
    	dlccc_ = dlccc;
    }

    /*
     * Return DL configuration change count
     */
    inline int getDlCCC() {
    	return dlccc_;
    }
    ...
    /*
     * Set UL configuration change count
     */
    inline void setUlCCC(int ulccc) {
    	ulccc_ = ulccc;
    }

    /*
     * Return UL configuration change count
     */
    inline int getUlCCC() {
    	return ulccc_;
    }
