...
static const char rcsid[] =
    "@(#) $Header: /home/rouil/cvsroot/ns-2.31/tools/ranvar.cc,v 1.1.1.1 2008/04/11 18:40:29 rouil Exp $ (Xerox)";
#endif
...
WeibullRandomVariable::WeibullRandomVariable
   (double shape, double scale, double location)
{
   shape_ = shape;
   scale_ = scale;
   location_ = location;
...
{
   return(rng_->weibull(shape_, scale_, location_));
}
