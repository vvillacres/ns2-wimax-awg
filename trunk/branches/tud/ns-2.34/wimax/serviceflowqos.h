...
public:
     ...
     */
    inline u_int32_t getMinReservedRate () {
        return min_reserved_traffic_rate_;
    }

    /**
     * Return the period
     */
    inline u_int16_t  getPeriod () {
        return period_;
    }
...
//start
    ...
    inline u_int8_t getTrafficPriority () {
        return traffic_priority_;
    }

    /**
     * Return the peak traffic rate
     */
    inline u_int32_t getPeakTrafficRate () {
        return peak_traffic_rate_;
    }
     ...
     */
    inline u_int32_t getMinTolerableTrafficRate () {
        return min_tolerable_traffic_rate_;
    }

    /**
     * Return the request/transmit policy
     */
    inline u_int32_t getReqTransmitPolicy () {
        return reqtransmit_policy_;
    }

    /**
     * Return the jitter value
     */
    inline u_int32_t getJitter () {
        return jitter_;
    }
     ...
     */
    inline u_int8_t getSDUIndicator () {
        return sdu_indicator_;
    }
     ...
     */
    inline u_int32_t getMaxBurstSize () {
...
//end
     ...
     */
    inline u_char  getIsArqEnabled () {
        return is_arq_enabled_;
    }
    ...
    */
    inline double getArqRetransTime () {
        return arq_retrans_time_;
    }

    /**
    * Return the ARQ maximum window
    */
    inline u_int32_t getArqMaxWindow () {
        return arq_max_window_;
    }
    ...
    */
     ...
     */
    inline void  setBurstSize (int size) {
        burstsize_ = size;
    }
     ...
     * Set the data size
     */
    inline void  setDataSize (double data_size) {
     ...
     * Set the period
     */
    inline void  setPeriod (u_int16_t period) {
        period_ = period;
    }
...
//start
     ...
     */
    inline void setTrafficPriority (u_int8_t traffic_priority) {
        traffic_priority_ = traffic_priority;
    }

    /**
     * Set the peak traffic rate
     */
    inline void setPeakTrafficRate (u_int32_t peak_traffic_rate) {
        peak_traffic_rate_ = peak_traffic_rate;
    }

    /**
     * Set the minimum reserved traffic rate
     */
    inline void setMinReservedTrafficRate (u_int32_t min_reserved_traffic_rate) {
        min_reserved_traffic_rate_ = min_reserved_traffic_rate;
    }

    /**
     * Set the request/transmit policy
     */
    inline void setReqTransmitPolicy (u_int32_t reqtransmit_policy) {
        reqtransmit_policy_ = reqtransmit_policy;
    }

    /**
     * Set the jitter value.
     */
    inline void setJitter (u_int32_t jitter) {
        jitter_ = jitter;
    }
     ...
     */
    inline void setSDUIndicator (u_int8_t sdu_indicator) {
        sdu_indicator_ = sdu_indicator;
    }

    /**
     * Set the minimum tolerable traffic rate
     */
    inline void setMinTolerableTrafficRate (u_int32_t min_tolerable_traffic_rate) {
        min_tolerable_traffic_rate_ = min_tolerable_traffic_rate;
    }

    /**
     * Set the SDU size
     */
    inline void setSDUSize (u_int8_t sdu_size) {
        sdu_size_ = sdu_size;
    }
     ...
     */
    inline void setMaxBurstSize (u_int32_t max_burst_size) {
     ...
     * Set SAID
     */
    inline void setSAID (u_int16_t said) {
        said_ = said;
    }
...
//end
     ...
     * Set the ARQ Status
     */
    inline void  setIsArqEnabled (u_char is_arq_enabled) {
        is_arq_enabled_ = is_arq_enabled;
    }

    /**
    * Set the ARQ retrans time
    */
    inline void setArqRetransTime (double arq_retrans_time) {
    ...
    */
    inline void setArqMaxWindow ( u_int32_t arq_max_window) {
        arq_max_window_ = arq_max_window;
    }
