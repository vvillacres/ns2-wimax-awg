...
public:
    ...
    ServiceFlowQosSet (
    		...
    		double arqRetransTime,
    		u_int8_t ackProcessingTime,
   ...
   * Does this correspont to 11.13.17.9 RECEIVER_ARQ_ACK_PROCESSING_TIME TLV ???
   */
   inline u_int8_t getArqAckProcessingTime () {
	   return ackProcessingTime_;
   }
    ...
    * Does this correspont to 11.13.17.9 RECEIVER_ARQ_ACK_PROCESSING_TIME TLV ???
    */
   inline void setArqAckProcessingTime (u_int8_t ackProcessingTime ) {
        ackProcessingTime_ = ackProcessingTime;
    }
...
private:
    ...
    */
    double        arqRetransTime_;

    /**
    * ARQ ack timing period - set by user
    */
    u_int8_t      ackProcessingTime_;
