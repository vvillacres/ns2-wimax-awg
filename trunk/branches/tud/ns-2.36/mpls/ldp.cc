 ...
 * $Id: ldp.cc,v 1.10 2014/12/17 22:16:09 tom_henderson Exp $
 *
...
//
// $Header: /cvsroot/nsnam/ns-2/mpls/ldp.cc,v 1.10 2014/12/17 22:16:09 tom_henderson Exp $
...
{
	for (int i = 0; i < MSGT_.NB; i++) {
		std::cerr << "  # MsgID =" << MSGT_.Entry[i].MsgID << "  ";
		std::cerr << "  # FEC   =" << MSGT_.Entry[i].FEC   << "  ";
		std::cerr << "  # LspID =" << MSGT_.Entry[i].LspID << "  ";
		std::cerr << "  # Src   =" << MSGT_.Entry[i].Src   << "  ";
		std::cerr << "  # PMsgID=" << MSGT_.Entry[i].PMsgID<< "  ";
		std::cerr << "  # LabelOp=" << MSGT_.Entry[i].LabelOp << "\n";
	}
}
