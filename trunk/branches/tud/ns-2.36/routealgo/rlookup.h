...
public :
  ...
  //  friend std::ostream& operator<<(std::ostream&, const RLookup& ); // Output a routing table
};
...
public :
  ...
  //  friend std::ostream& operator<<(std::ostream&, const FRLookup& ); // Output a routing table
private:
  nodeid_t m_Default;  
};
...
public :
  ...
  static  size_t   EstimateSize(
                        ...
                        nodeid_t f,      // First non-default
                        nodeid_t l);     // Last non-default
  //  friend std::ostream& operator<<(std::ostream&, const BMLookup& ); // Output a bitmap routing table
private:
  nodeid_t     m_Default;  
...
typedef std::hash_map<nodeid_t, nodeid_t,
                 std::hash<nodeid_t>, std::equal_to<nodeid_t> > RouteMap_t;
#else
...
public :
  ...
  static  size_t   EstimateSize(
                        ...
                        nodeid_t f,      // First non-default
                        nodeid_t l);     // Last non-default
  //  friend std::ostream& operator<<(std::ostream&, const HMLookup& ); // Output a routing table
private:
  nodeid_t     m_Default;  
