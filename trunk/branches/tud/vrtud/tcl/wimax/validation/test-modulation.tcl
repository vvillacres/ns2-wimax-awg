...
if {$argc != 4} {
    puts ""
    puts "Wrong Number of Arguments! 3 arguments in this topology"
    puts "Syntax: ns test-be.tcl seed profile\[1-7\] dl/ul distance"
    puts ""
    exit 1
}
...
set diuc [lindex $argv 1]		;# diuc profile [1-7]
set direction [lindex $argv 2]          ;# traffic direction
set distance [lindex $argv 3]           ;# distance of the MS from the BS
