...
struct phy_info_t {
    ...
    int mcs_index_; //modulation only is not enough, need MCS index.
...
/*xingting added for ffb type*/
enum fast_feedback_type {
    FFB_MIMO_PRECODING,
    FFB_MIMO_MODE,
    FFB_UEP,
    FFB_BAND_AMC_CINR,
...
/*SS sends this to BS to request a CQICH channel.*/
struct mac_hdr_cqich_alloc_request {
    u_int16_t ht:1;
    u_int16_t ec:1;
    u_int16_t type:3;
    u_int16_t fb_type:3;
    u_int16_t fbssi:1;
    u_int16_t preferred_period:3;
    u_int16_t reserved:12;
    u_int16_t cid;
};

/*SS uses this to report FFB message.*/
struct mac_hdr_ffb_report {
    u_int16_t ht:1;
    u_int16_t ec:1;
    u_int16_t type:1;  // 0:  feedback header.  1: MIMO channel feedback header.
    u_int16_t cii:1;
    u_int16_t fb_type:4;
    int16_t fb_content;
    u_int16_t cid;
...
#define FFB_REPORT_SIZE  0.5

/*BS uses to control the feedback mode from SS*/
struct mac_ext_cqich_alloc_ie {
    u_int8_t ext_uiuc:4;
    u_int8_t length:4;
    u_int16_t cqich_id;
    u_int16_t alloc_offset:6;
    u_int16_t period:2;
    u_int16_t frame_offset:3;
    u_int16_t duration:6;
    u_int8_t fb_type:3;
    u_int8_t report_type:1;
    u_int8_t zone_permutation:3;
    u_int8_t zone_type:2;
    u_int16_t ss_mac_id;
};
...
struct mac802_16_ulmap_ie {
    ...
    mac_ext_cqich_alloc_ie cqich_alloc_ie;   /*Allocate the feedback mode to SS.
   									    Need to set the extent UIUC.*/
    bool isCqichSlot;
