...
{
public:
    WimaxBackoffTimer(ContentionRequest *c, Mac802_16 *m) : WimaxTimer(m) {
        c_=c;
    }
...
{
public:
    ContCountTimer(ContentionRequest *c, Mac802_16 *m) : WimaxTimer(m) {
        c_=c;
    }
...
public:
    ...
    ContentionRequest* next_entry(void) const {
        return link.le_next;
    }
...
public:
    ...
    inline int getBACKOFF () {
        return s_backoff_;
    }
    inline int getTIMEOUT () {
        return s_timeout_;
    }
    inline int getNBRETRY () {
        return s_nbretry_;
    }
    ...
    inline int getFLAGTRANSMIT ()     {
        return s_flagtransmit_;
    }
    inline int getFLAGNOWTRANSMIT ()  {
        return s_flagnowtransmit_;
    }
    inline Packet * getPacket_P ()    {
        return pnew_;
    }
    inline Packet * getPacket_P_mac () {
        return pnew_;
    }
    ...
    inline void setBACKOFF (int backoff) {
        s_backoff_ = backoff;
    }
    inline void setTIMEOUT (int timeout) {
        s_timeout_ = timeout;
    }
    inline void setNBRETRY (int nbretry) {
        s_nbretry_ = nbretry;
    }
    ...
    inline void setFLAGTRANSMIT  (int flagtransmit)       {
        s_flagtransmit_ = flagtransmit;
    }
    inline void setFLAGNOWTRANSMIT  (int flagnowtransmit) {
        s_flagnowtransmit_ = flagnowtransmit;
    }
    inline void setPacket_P_mac  (Packet * p)             {
        *pnew_ = *p;
    }
...
//  BwRequest (ContentionSlot *s, Packet *p, int cid, int length);
    ...
    inline void setPacket_P  (Packet * p)                 {
        *pnew_ = *p;
    }
