...
public:
     ...
     */
    inline void setChannelID (int id) {
        channel_ = id;
    }
     ...
     */
    inline DlSubFrameTimer *getTimer () {
        return timer_;
    }
...
public:
     ...
     * @return the phypdu
     */
    inline PhyPdu * getFirstPdu () {
        return phypdu_list_.lh_first;
    }
     ...
     */
    inline BwContentionSlot* getBw_req( ) {
        return bw_req_;
    }

    /*
     * Return the contention slot for Ranging requests
     * @return the pointer to the contention slot for Ranging requests
     */
    inline RngContentionSlot* getRanging( ) {
        return ranging_;
    }
     ...
     * Return the timer handling the subframe
     */
    inline UlSubFrameTimer *getTimer () {
        return timer_;
    }
