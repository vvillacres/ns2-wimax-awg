...
//      does not support it.
static const unsigned long DL_OFDMA_DATA [][NB_OFDMA_PHY_PARAM] = {{PUSC, 5000000, 512, 421, 15, 28, 24, 1, 2},
...
//Note: Currently comment 20MHz data since the propagation model
//      does not support it.
static const unsigned long UL_OFDMA_DATA [][NB_OFDMA_PHY_PARAM] = {{PUSC, 5000000, 512, 409, 17, 24, 16, 1, 3},
